...
Структура сценария: <Сценарий>
    Дано  Я очищаю параметры команды "git2reposync" в контексте
    ...
    И Я добавляю параметр "all" для команды "git2reposync"
    И Я добавляю параметр <ДопПараметрыЗапуска> для команды "git2reposync"
    И Я добавляю позиционный параметр для команды "git2reposync" из переменной "FILE"
    Когда Я выполняю команду "git2reposync"
    Тогда Вывод команды "git2reposync" содержит <Результат>
